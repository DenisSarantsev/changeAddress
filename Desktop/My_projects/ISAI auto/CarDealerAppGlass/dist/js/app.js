(() => {
    ...
    document.addEventListener("DOMContentLoaded", (function() {
        if (document.querySelector(".calculator")) {
            const arrayLand = [ {
                ...
                Copart: {
                    place: {
                        ...
                        price: {
                            легковий: "Call for price",
                            мото: "Call for price",
                            паркетник: "Call for price",
                            позашляховик: "Call for price"
                        },
                        port: "ANCHORAGE"
                    }
                }
                ...
                Copart: {
                    place: {
                        title: "CHICAGO SOUTH-Woodmar/Heights sublot - Illinois",
                        price: {
                            легковий: 180,
                            мото: 180,
                            паркетник: 180,
                ...
                Copart: {
                    place: {
                        title: "CRASHEDTOYS ATLANTA - Georgia",
                        price: {
                            легковий: 275,
                            мото: 250,
                            паркетник: 275,
                ...
                Copart: {
                    place: {
                        title: "CRASHEDTOYS DALLAS - Texas",
                        price: {
                            легковий: 275,
                            мото: 185,
                            паркетник: 275,
                ...
                Copart: {
                    place: {
                        title: "CRASHEDTOYS SACRAMENTO - California",
                        price: {
                            легковий: "Call for price",
                            мото: 300,
                            паркетник: "Call for price",
                ...
                Copart: {
                    place: {
                        title: "DAVENPORT - 169 Davenport sublot - Iowa",
                        price: {
                            легковий: 325,
                            мото: 275,
                            паркетник: 325,
                ...
                Copart: {
                    place: {
                        title: "GLASSBORO EAST - New Jersey",
                        price: {
                            легковий: 200,
                            мото: 165,
                            паркетник: 200,
                ...
                Copart: {
                    place: {
                        title: "GLASSBORO WEST - New Jersey",
                        price: {
                            легковий: 200,
                            мото: 165,
                            паркетник: 200,
                ...
                Copart: {
                    place: {
                        title: "HARTFORD SPRINGFIELD - Connecticut",
                        price: {
                            легковий: 250,
                            мото: 200,
                            паркетник: 250,
                ...
                Copart: {
                    place: {
                        title: "JACKSONVILLE EAST - Florida",
                        price: {
                            легковий: 225,
                            мото: 175,
                            паркетник: 225,
                ...
                Copart: {
                    place: {
                        title: "JACKSONVILLE NORTH - Florida",
                        price: {
                            легковий: 225,
                            мото: 175,
                            паркетник: 225,
                ...
                Copart: {
                    place: {
                        title: "JACKSONVILLE WEST - Florida",
                        price: {
                            легковий: 225,
                            мото: 175,
                            паркетник: 225,
                ...
                Copart: {
                    place: {
                        title: "MILWAUKEE NORTH - Wisconsin",
                        price: {
                            легковий: 225,
                            мото: 225,
                            паркетник: 225,
                ...
                Copart: {
                    place: {
                        title: "MILWAUKEE SOUTH - Wisconsin",
                        price: {
                            легковий: 225,
                            мото: 225,
                            паркетник: 225,
                ...
                Copart: {
                    place: {
                        title: "MINNEAPOLIS NORTH - Minnesota",
                        price: {
                            легковий: 450,
                            мото: 350,
                            паркетник: 450,
                ...
                Copart: {
                    place: {
                        title: "N.Boston-ROWLEY Sublot - Massachusetts",
                        price: {
                            легковий: 450,
                            мото: 450,
                            паркетник: 450,
                ...
                Copart: {
                    place: {
                        title: "NORTH BOSTON - Massachusetts",
                        price: {
                            легковий: 375,
                            мото: 250,
                            паркетник: 375,
                ...
                Copart: {
                    place: {
                        title: "NORTH SEATTLE - Washington",
                        price: {
                            легковий: 200,
                            мото: 200,
                            паркетник: 200,
                ...
                Copart: {
                    place: {
                        title: "PHILADELPHIA EAST-SUBLOT - Pennsylvania",
                        price: {
                            легковий: 200,
                            мото: 125,
                            паркетник: 200,
                ...
                Copart: {
                    place: {
                        title: "PITTSBURGH EAST - Pennsylvania",
                        price: {
                            легковий: 400,
                            мото: 300,
                            паркетник: 400,
                ...
                Copart: {
                    place: {
                        title: "PITTSBURGH NORTH - Pennsylvania",
                        price: {
                            легковий: 450,
                            мото: 325,
                            паркетник: 450,
                ...
                Copart: {
                    place: {
                        title: "PITTSBURGH SOUTH - Pennsylvania",
                        price: {
                            легковий: 450,
                            мото: 325,
                            паркетник: 450,
                ...
                Copart: {
                    place: {
                        title: "PITTSBURGH WEST - Pennsylvania",
                        price: {
                            легковий: 450,
                            мото: 325,
                            паркетник: 450,
                ...
                Copart: {
                    place: {
                        title: "PUNTA GORDA SOUTH - Florida",
                        price: {
                            легковий: 275,
                            мото: 250,
                            паркетник: 275,
                ...
                Copart: {
                    place: {
                        title: "SALT LAKE CITY NORTH - Utah",
                        price: {
                            легковий: 550,
                            мото: 500,
                            паркетник: 550,
                ...
                Copart: {
                    place: {
                        title: "SAVANNAH / VERTIA SUBLOT-Georgia Copart - Georgia -",
                        price: {
                            легковий: 175,
                            мото: 150,
                            паркетник: 175,
                ...
                Copart: {
                    place: {
                        title: "SC - COLUMBIA - South Carolina",
                        price: {
                            легковий: 275,
                            мото: 200,
                            паркетник: 275,
                ...
                Copart: {
                    place: {
                        title: "SO SACRAMENTO - California",
                        price: {
                            легковий: 400,
                            мото: 300,
                            паркетник: 400,
                ...
                Copart: {
                    place: {
                        title: "SOUTH BOSTON - Massachusetts",
                        price: {
                            легковий: 375,
                            мото: 250,
                            паркетник: 375,
                ...
                Copart: {
                    place: {
                        title: "ST. JOHN'S - Newfoundland and Lab",
                        price: {
                            легковий: 1850,
                            мото: 1650,
                            паркетник: 1950,
                ...
                Copart: {
                    place: {
                        title: "Southern Illinois - Illinois",
                        price: {
                            легковий: 575,
                            мото: 425,
                            паркетник: 575,
                ...
                Copart: {
                    place: {
                        title: "TAMPA SOUTH - Mulberry Sublot - Florida",
                        price: {
                            легковий: 275,
                            мото: 250,
                            паркетник: 275,
                ...
                Copart: {
                    place: {
                        title: "WAYLAND - Michigan - Michigan",
                        price: {
                            легковий: 400,
                            мото: 300,
                            паркетник: 400,
                ...
                Copart: {
                    place: {
                        title: "WEST WARREN - Massachusetts",
                        price: {
                            легковий: 375,
                            мото: 250,
                            паркетник: 375,
                ...
                IAAI: {
                    place: {
                        title: "AVENEL NEW JERSEY - New Jersey",
                        price: {
                            легковий: 125,
                            мото: 75,
                            паркетник: 125,
                ...
                IAAI: {
                    place: {
                        title: "BOSTON - SHIRLEY - Massachusetts",
                        price: {
                            легковий: 375,
                            мото: 250,
                            паркетник: 375,
                ...
                IAAI: {
                    place: {
                        title: "BUCKHANNON - West Virginia",
                        price: {
                            легковий: 625,
                            мото: 500,
                            паркетник: 625,
                ...
                IAAI: {
                    place: {
                        title: "CENTRAL NEW JERSEY - New Jersey",
                        price: {
                            легковий: 150,
                            мото: 125,
                            паркетник: 150,
                ...
                IAAI: {
                    place: {
                        title: "D&D TOWING INC MAUI - Hawaii",
                        price: {
                            легковий: 2400,
                            мото: 2400,
                            паркетник: 2400,
                ...
                IAAI: {
                    place: {
                        title: "Fredericksburg-South - Virginia",
                        price: {
                            легковий: 250,
                            мото: 200,
                            паркетник: 250,
                ...
                IAAI: {
                    place: {
                        title: "HARTFORD-SOUTH - Connecticut",
                        price: {
                            легковий: 225,
                            мото: 175,
                            паркетник: 225,
                ...
                IAAI: {
                    place: {
                        title: "Indianapolis South - Indiana",
                        price: {
                            легковий: 600,
                            мото: 400,
                            паркетник: 600,
                ...
                IAAI: {
                    place: {
                        title: "Kansas City East - Missouri",
                        price: {
                            легковий: 625,
                            мото: 450,
                            паркетник: 625,
                ...
                IAAI: {
                    place: {
                        title: "LEE'S TOWING KAUAI - Hawaii",
                        price: {
                            легковий: 2750,
                            мото: 2750,
                            паркетник: 3150,
                ...
                IAAI: {
                    place: {
                        title: "LOUISVILLE NORTH - Kentucky",
                        price: {
                            легковий: 550,
                            мото: 375,
                            паркетник: 550,
                ...
                IAAI: {
                    place: {
                        title: "Los Angeles South - California",
                        price: {
                            легковий: 150,
                            мото: 150,
                            паркетник: 150,
                ...
                IAAI: {
                    place: {
                        title: "MINNEAPOLIS/ST. PAUL - Minnesota",
                        price: {
                            легковий: 450,
                            мото: 350,
                            паркетник: 450,
                ...
                IAAI: {
                    place: {
                        title: "Minneapolis South - Minnesota",
                        price: {
                            легковий: 450,
                            мото: 350,
                            паркетник: 450,
                ...
                IAAI: {
                    place: {
                        title: "NEW ORLEANS EAST - Louisiana",
                        price: {
                            легковий: 425,
                            мото: 375,
                            паркетник: 425,
                ...
                IAAI: {
                    place: {
                        title: "NORTH HOLLYWOOD - California",
                        price: {
                            легковий: 200,
                            мото: 200,
                            паркетник: 200,
                ...
                IAAI: {
                    place: {
                        title: "NORTHERN NEW JERSEY - New Jersey",
                        price: {
                            легковий: 125,
                            мото: 75,
                            паркетник: 125,
                ...
                IAAI: {
                    place: {
                        title: "NORTHERN VIRGINIA - Virginia",
                        price: {
                            легковий: 250,
                            мото: 200,
                            паркетник: 250,
                ...
                IAAI: {
                    place: {
                        title: "New Orleans and Louisiana Flood - Louisiana",
                        price: {
                            легковий: 425,
                            мото: 375,
                            паркетник: 425,
                ...
                IAAI: {
                    place: {
                        title: "Philadelphia East - Pennsylvania",
                        price: {
                            легковий: 200,
                            мото: 125,
                            паркетник: 200,
                ...
                IAAI: {
                    place: {
                        title: "SHADY SPRING - West Virginia",
                        price: {
                            легковий: 625,
                            мото: 500,
                            паркетник: 625,
                ...
                IAAI: {
                    place: {
                        title: "SOUTHERN NEW JERSEY - New Jersey",
                        price: {
                            легковий: 200,
                            мото: 165,
                            паркетник: 200,
                ...
                IAAI: {
                    place: {
                        title: "WESTERN COLORADO - Colorado",
                        price: {
                            легковий: "Call for price",
                            мото: "Call for price",
                            паркетник: "Call for price",
                ...
                IAAI: {
                    place: {
                        title: "YORK SPRINGS - Pennsylvania",
                        price: {
                            легковий: 275,
                            мото: 225,
                            паркетник: 275,
            ...
            const hybridRate = 100;
            const euroDollarCoef = 1.07;
            const certificate = 40;
            const deliveryFromPort = 750;
            const brocker = 150;
            const expedition = 4450;
            const companyServices = 5500;
            const areaSelect = document.querySelector(".area__list");
            document.querySelector(".area__list-container");
            ...
            function userSelectedData() {
                ...
                if (yearInput.value.length === 4) if (currentYear - yearInput.value < 15) carAge = currentYear - yearInput.value - 1; else carAge = 15;
            }
            ...
            const auctionPriceResult = document.querySelector(".result-auction-price");
            const USDeliveryPriceResult = document.querySelector(".result-us-delivery");
            const seaResult = document.querySelector(".result-sea");
            ...
            const insuranceResult = document.querySelector(".result-insurance");
            const companyService = document.querySelector(".result-company-service");
            const certificateResult = document.querySelector(".result-certificate");
            const expeditionResult = document.querySelector(".result-expedition");
            const brokerResult = document.querySelector(".result-broker");
            const deliveryFromPortResult = document.querySelector(".result-delivery-from-port");
            const finGarantyResult = document.querySelector(".result-fin-garanty");
            const insuranceDangerousCargoResult = document.querySelector(".result-insurance-dangerous-cargo");
            ...
            function calculateTaxes() {
                let actualRate;
                let exciseResult;
                const euroToDollarCoef = euroDollarCoef;
                let exciseResultDollar;
                if (yearInput.value.length < 4) exciseResultDollar = ""; else if (selectedEngineType === "gasoline") {
                ...
                let importTax = 0;
                if (selectedEngineType === 0 || !customsDutyResult.value && selectedEngineType === "electro" || priceLotInput.value === "") importTax = 0; else if (selectedEngineType === 0 || !customsDutyResult.value && selectedEngineType !== "electro") {
                ...
                if (priceLotInput.value === "") {
                    MPETax = 0;
                    pdvDutyResult.textContent = 0;
                } else if (selectedEngineType === "hybrid" || selectedEngineType === "gasoline" || selectedEngineType === "diesel") {
                    MPETax = (+priceLotInput.value + 1600 + +auctionPriceResult.textContent + +exciseResultDollar + +importTax) / 5;
            ...
            expeditionInput.value = expedition;
            ...
            companyServicesInput.value = companyServices;
            ...
            function selectAuction() {
                ...
                if (document.querySelector(".selected-auction").classList.contains("auction-copart-button")) copartPlacesAdd(); else if (document.querySelector(".selected-auction").classList.contains("auction-iaai-button")) iaaiPlacesAdd();
            }
            ...
            function copartPlacesAdd() {
                ...
                for (let i = 0; i < arrayLand.length; i++) {
                    ...
                    if (firstKey === "Copart") currentArray.push(arrayLand[i]["Copart"]["place"]["title"]);
                }
            ...
            function iaaiPlacesAdd() {
                ...
                for (let i = 0; i < arrayLand.length; i++) {
                    let firstKey = Object.keys(arrayLand[i])[0];
                    if (firstKey === "IAAI") currentArray.push(arrayLand[i]["IAAI"]["place"]["title"]);
                }
                sortCurrentArray(currentPlace, currentArray);
            }
            function sortCurrentArray(place, array) {
                ...
                for (let i = 0; i < array.length; i++) if (array[i].substr(0, currentSearchWordLength) === currentSearchWord.toUpperCase()) sortedCurrentArray.push(array[i]); else if (currentSearchWord === "") sortedCurrentArray = array;
                areaSelect.innerHTML = "";
                for (let i = 0; i < sortedCurrentArray.length; i++) areaSelect.insertAdjacentHTML("beforeend", `<p><div value="${sortedCurrentArray[i]}" class="area__list-item">${sortedCurrentArray[i]}</div></p>`);
            }
            ...
            document.addEventListener("click", (event => {
                if (event.target.classList.contains("search-list-item")) openPlacesList(); else if (!event.target.classList.contains("area__list-item") && !event.target.classList.contains("area__list")) closePlacesList();
            }));
            let areaListItems = document.querySelectorAll(".area__list-item");
            for (let item of areaListItems) item.addEventListener("wheel", (function(event) {
            ...
            function addCurrentPlaceInSearchInput() {
                ...
                for (let item of currentItemsArray) item.addEventListener("click", (event => {
                    closePlacesList();
            ...
            for (let item of auctionButtonsArray) item.addEventListener("click", (() => {
                if (searchListItem.value === "") areaListPlaceSelect = "";
                if (areaListPlaceSelect === "") {
                    auctionPriceResult.textContent = 0;
                    seaResult.textContent = 0;
                    auctionPriceResult.value = 0;
                    seaResult.value = 0;
                }
            }));
            ...
            function calculateLandDelivery() {
                ...
                if (document.querySelector(".selected-auction").classList.contains("auction-copart-button")) for (let i = 0; i < arrayLand.length; i++) {
                    let firstKey = Object.keys(arrayLand[i])[0];
                    if (firstKey === "Copart" && arrayLand[i]["Copart"]["place"]["title"] === areaListPlaceSelect) {
                        ...
                        for (let item of bodiesArray) if (item.classList.contains("selected-body")) if (currentAreaPrices[`${item.value}`] === "Call for price" || currentAreaPrices[`${item.value}`] === "") USDeliveryPriceResult.textContent = "Уточнюйте у менеджера"; else USDeliveryPriceResult.textContent = currentAreaPrices[`${item.value}`];
                    }
                } else if (document.querySelector(".selected-auction").classList.contains("auction-iaai-button")) for (let i = 0; i < arrayLand.length; i++) {
                    let firstKey = Object.keys(arrayLand[i])[0];
            ...
            function calculateSeaDelivery() {
                ...
                const bodiesArray = document.querySelectorAll(".body__button");
                let currentBody = "";
                for (let item of bodiesArray) if (item.classList.contains("selected-body")) currentBody = item.value;
                if (document.querySelector(".selected-auction").classList.contains("auction-copart-button")) currentAuction = "Copart"; else if (document.querySelector(".selected-auction").classList.contains("auction-iaai-button")) currentAuction = "IAAI";
                for (let i = 0; i < arrayLand.length; i++) {
                    let firstKey = Object.keys(arrayLand[i])[0];
                ...
                for (let i = 0; i < arraySee.length; i++) {
                    ...
                    if (firstKey === currentPort) {
                        ...
                        if (currentPriceByPort === "" || currentPriceByPort === 0) seaResult.textContent = "Уточнюйте у менеджера"; else seaResult.textContent = currentPriceByPort;
                    }
                }
            }
            function treatmentArraFee(array) {
                ...
                for (let i = 0; i < array.length; i++) {
                    ...
                    if (actualPrice >= +priceFork[0] && actualPrice <= +priceFork[1]) actualFee = Math.round(array[i][1]);
                    if (array[i][0].indexOf("+") !== -1) {
                        const actualPercent = +("0.0" + Math.round(array[i][1].replace("%", "")));
                        actualPercentSum = actualPrice * actualPercent;
                    }
                    if (array[i][0] === "addSum") addSum = Math.round(array[i][1]);
                }
                if (actualPrice === 0 || actualPrice === "") resultFee = 0; else if (actualPrice < 15e3) resultFee = actualFee + addSum; else if (actualPrice > 15e3) resultFee = actualPercentSum + addSum;
                auctionPriceResult.textContent = Math.round(resultFee);
            }
            function calculateAuctionFee() {
                if (document.querySelector(".selected-auction").classList.contains("auction-copart-button")) treatmentArraFee(arrayFeeCopart); else if (document.querySelector(".selected-auction").classList.contains("auction-iaai-button")) treatmentArraFee(arrayFeeIAAI);
            }
            function calculateInsuranceResult() {
                insuranceResult.textContent = 0;
                const actualPrice = +priceLotInput.value;
                const actualFee = +auctionPriceResult.textContent;
                insuranceResult.textContent = Math.round((actualPrice + actualFee) * .015);
            }
            function calculateDeliveryToUkraine() {
                deliveryFromPortResult.textContent = deliveryFromPort;
            }
            function calculateFinGaranty() {
                finGarantyResult.textContent = 0;
                if (selectedEngineType !== "electro") finGarantyResult.textContent = 0; else finGarantyResult.textContent = 150;
            }
            function calculateInsuranceDangerousCargo() {
                let currentAuction = "";
                let currentPort = "";
                if (document.querySelector(".selected-auction").classList.contains("auction-copart-button")) currentAuction = "Copart"; else if (document.querySelector(".selected-auction").classList.contains("auction-iaai-button")) currentAuction = "IAAI";
                for (let i = 0; i < arrayLand.length; i++) {
            ...
            function calculateFullPrice() {
                ...
                let fullPrice = 0;
                fullPrice = +priceLotInput.value + +allTaxes + +brokerService + +expeditionPrice + +companyServicePrice + +repairPrice + +auctionPriceResult.textContent + +insuranceResult.textContent + +certificateResult.textContent + +deliveryFromPortResult.textContent + +finGarantyResult.textContent + +insuranceDangerousCargoResult.textContent;
                let notFullPrice = 0;
                if (USDeliveryPriceResult.textContent === "Уточнюйте у менеджера") notFullPrice = 1; else fullPrice += +USDeliveryPriceResult.textContent;
                if (seaResult.textContent === "Уточнюйте у менеджера") notFullPrice = 1; else fullPrice += +seaResult.textContent;
                if (notFullPrice === 1) {
                    let price = Math.round(fullPrice);
                    fullPriceResult.textContent = `(Ціна неповна) ${price}`;
                } else fullPriceResult.textContent = Math.round(fullPrice);
            }
            ...
            function callAllFunctions() {
                ...
                calculateDeliveryToUkraine();
                calculateCertificatePrice();
                calculateFinGaranty();
                calculateInsuranceDangerousCargo();
            }
