        ...
        if (document.querySelector(".calculator")) {
            ...
            function copartPlacesAdd() {
                ...
                for (let i = 0; i < arrayLand.length; i++) {
                    ...
                    if (firstKey === "Copart" && counter === 1) ; else if (firstKey === "Copart") currentArray.push(arrayLand[i]["Copart"]["place"]["title"]);
                }
            ...
            function iaaiPlacesAdd() {
                ...
                for (let i = 0; i < arrayLand.length; i++) {
                    ...
                    if (firstKey === "IAAI" && counter === 1) ; else if (firstKey === "IAAI") currentArray.push(arrayLand[i]["IAAI"]["place"]["title"]);
                }
                sortCurrentArray(currentPlace, currentArray);
            }
            ...
            function calculateFullPrice() {
                ...
                let fullPrice = 0;
                fullPrice = +priceLotInput.value + +allTaxes + +brokerService + +expeditionPrice + +companyServicePrice + +repairPrice + +auctionPriceResult.textContent + +insuranceResult.textContent + +certificateResult.textContent + +deliveryFromPortResult.textContent;
                let notFullPrice = 0;
